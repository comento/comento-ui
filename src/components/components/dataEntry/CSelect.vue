			...
			<CList spacing>
				<template v-for="(option, index) in options">
					...
					>
						...
						<CIcon v-if="option.icon" :name="option.icon" class="c-pointer" />
					</CListItem>
					<CDivider :key="index" />
				</template>
			</CList>
...
import CDropdown from '@/components/components/dataEntry/CDropdown';
...
import CEtcIcon from '@/components/elements/core/icon/CEtcIcon';
