		...
		<div class="information-wrapper">
			<div class="name-company-wrapper">
				<div class="name-icon-wrapper">
					<CTypography :type="computedNameTypography" color="gray850" font-weight="bold" class="name">
						<slot name="name" />
					</CTypography>
			...
			<CTypography v-if="isShowOther" class="other-wrapper" type="caption1" color="gray400">
				<slot name="other" />
			</CTypography>
		</div>
	</div>
