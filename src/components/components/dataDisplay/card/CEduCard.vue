	...
	<article class="c-application c-edu-card" v-bind="$attrs" v-on="$listeners">
		<div class="c-edu-card--info-container">
			<div class="c-edu-card--subtitle mb-4">
				<CTypography type="caption1" color="gray800" :font-weight="700">
					{{ category }}
				</CTypography>
			</div>
			<div class="c-edu-card--title mb-8">
				<CTypography type="body1" color="gray900">
					<slot name="title" />
				</CTypography>
			</div>
			<div class="c-edu-card--caption">
				<CTypography type="caption1" element="span" color="gray500">
					{{ captionLeft }}
				</CTypography>
				<CDivider v-show="captionRight" vertical class="mx-8" />
				<CTypography type="caption1" element="span" color="gray500"> {{ captionRight }}</CTypography>
