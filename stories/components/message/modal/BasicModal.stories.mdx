...
export const Default = (args, { argTypes }) => ({
    ...
    components: { CBasicModal, CButton },
    template: `
        <div>
...
<Canvas>
    <Story name="Scroll" height="100px">
        {{
            ...
            template: `
                <div>
                    <div style="margin-bottom: 10px">
                        <CButton @click="showModal1 = true">Open</CButton>
                        <CBasicModal :show.sync="showModal1" align="left" scroll>
                            <template v-slot:title>
                                모달 제목
                            </template>
                            <template v-slot:content>
                    ...
                    <div>
                        <CButton @click="showModal2 = true">Open</CButton>
                        <CBasicModal :show.sync="showModal2" align="left" show-action-button scroll :success-callback="closeModal">
                            <template v-slot:title>
                                모달 제목
                            </template>
                            <template v-slot:content>
            ...
            components: { CButton, CBasicModal }
        }}
    </Story>
</Canvas>
