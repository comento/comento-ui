...
import CWithFormModal, { aligns } from '@/components/components/message/modal/CWithFormModal';
...
import CSelect from '@/components/components/dataEntry/CSelect';
                    ...
                    >
                        ...
                        <template v-slot:content>
                            <CInputGroup class="mb-12">
                                ...
                                <CButton type="outlined" color="primary" @click="handleSubmitModal">등록하기</CButton>
                            </CInputGroup>
                            <CInputGroup>
                                <span class="mr-4">
                                    <CTextField
                                ...
                                <CButton type="outlined" color="secondary" @click="handleSubmitModal">등록하기</CButton>
                            </CInputGroup>
                        </template>
                    </CWithFormModal>
                </div>
                ...
                <div>
                    ...
                    >
                        ...
                        <template v-slot:content>
                            ...
                            <CSelect v-model="value" full :options="['Option1', 'Option2', 'Option3', 'Option4', 'Option5']"></CSelect>
                        </template>
                    </CWithFormModal>
                </div>
            `,
                    ...
                    >
                        ...
                        <template v-slot:content>
                            ...
                            <div style="display: flex; flex-direction: row; align-items: center; justify-content: space-between">
                                <CTextField :value.sync="checkValue" full outlined placeholder="제출합니다" align="center" class="mr-4" />
                            </div>
                        </template>
                    </CWithFormModal>
                </div>
...
<Canvas>
    <Story name="Scroll" height="100px">
        {{
            ...
            template: `
                <div>
                    <CButton @click="show1 = true">Open</CButton>
