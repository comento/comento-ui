...
import CFullscreenModal, {fullScreenAlign, fullScreenCloseType} from '@/components/components/message/modal/CFullscreenModal';
                ...
                <div>
                    ...
                    >
                        ...
                        <template v-slot:action>
                            <CButton size="small" type="outlined"  @click="show = false">초기화</CButton>
                        </template>
                        <template v-slot:content>
                            <div style="padding:16px">
...
<Canvas>
    <Story name="Slot-Content" height="100px">
        {{
                        ...
                        <template v-slot:content>
                            <div class="pa-16 flex">
                                <div class="mr-8" @click="show = false" style="float:left; margin-top:4px">
                                    <CIcon name="IconArrowLargeLine" :rotate="-90"></CIcon>
                                </div>
                                <CSearchInput
            ...
            `,
            components: {
                CFullscreenModal, CButton, CSearchInput, CIcon
            }
        }}
    </Story>
</Canvas>
            ...
            template: `
                <div>
                    ...
                    >
                        ...
                        <template v-slot:action>
                            <CButton size="small" type="outlined" >초기화</CButton>
                        </template>
                        <template v-slot:content>
                            <div style="padding:16px">
                                - Close 부분을 감추고, Action 이벤트를 추가 할 수 있는 fullscreenModal 입니다.<br />
