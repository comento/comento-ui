...
export const Default = (args, { argTypes }) => ({
  ...
  template: `<div style="width: 100%; display: flex; justify-content: center; align-items: flex-start; flex-direction: column;">
   ...
   components: { FileInputButton, FileInputList },
});
          ...
          methods: {
            ...
            template: `<div style="width: 100%; display: flex; justify-content: center; align-items: center; flex-direction: column;">
                        <div style="width: 100%; margin-bottom: 30px;">
                            ...
                            <FileInputButton full
                              @uploadFiles="handleCreateUploadFiles"
                            />
                            <FileInputList :files="createFiles" isRemovable @clickFileTrashIcon="handleCreateClickTrashIcon" @clickFileItemContent="handleClickFileItemContent"/>
                        </div>
                        <div style="width: 100%; margin-bottom: 30px;">
                            <Typography type="body2">실패</Typography>
                            <FileInputButton full
                              @uploadFiles="handleErrorUploadFiles"
                            />
                            <FileInputList :files="errorFiles" isRemovable @clickFileTrashIcon="handleErrorClickTrashIcon" @clickFileItemContent="handleClickFileItemContent"/>
                        </div>
                         <div style="width: 100%; margin-bottom: 30px;">
                            ...
                            <FileInputList :files="mockFiles" @clickFileDownloadIcon="handleClickMockFileDownloadIcon" @clickFileItemContent="handleClickFileItemContent"/>
                        </div>
                      </div>`,
             components: { FileInputButton, FileInputList, FileSummary, Typography },
        }}
    </Story>
</Canvas>
