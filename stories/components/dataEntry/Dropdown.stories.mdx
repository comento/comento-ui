            ...
            template: `
                <div>
                    <div style="margin-bottom: 20px">
                        <Dropdown max-width="230px" label="searchInput Dropdown" :show-dropdown.sync="showSearchDropdown" v-click-outside="closeSearchList">
                            <template v-slot:item>
                                <SearchInput
                                    full
                                    :showSearchDropdown.sync="showSearchDropdown"
                    ...
                    <Dropdown max-width="230px" label="Input Dropdown" v-click-outside="closeInputList">
                        <template v-slot:item>
                            <TextField
