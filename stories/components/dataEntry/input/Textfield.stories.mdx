...
import CTextField, { TextFieldTypes, TextFieldAligns, TextFieldColor } from '@/components/components/dataEntry/input/CTextField';
                ...
                <CGrid>
                        ...
                        <CStyleCol :col-lg="4" col-gutters>
                            ...
                            >
                                <template v-slot:append>
                                    <CTypography type="caption2" color="gray700" class="mr-2">제휴 확인 중</CTypography>
                                    <CLoader size="small" color="secondary" style="margin-right: -2px" />
                                </template>
                            </CTextField>
                        </CStyleCol>
                    </CRow>
                    <CRow class="mb-10">
                        <CStyleCol :col-lg="4" col-gutters>
                            ...
                            >
                                <template v-slot:append>
                                    <CTypography type="caption2" color="gray800" class="mr-2">미제휴기관</CTypography>
                                    <CIcon name="IconExclamationSmallFill" color="gray500" />
                                </template>
                            </CTextField>
                        </CStyleCol>
                    </CRow>
                        ...
                        <CStyleCol :col-lg="4" col-gutters>
                            ...
                            >
                                <template v-slot:append>
                                    ...
                                    <CIcon name="IconExclamationSmallFill" color="primary" />
                                </template>
                            </CTextField>
                        </CStyleCol>
                    </CRow>
