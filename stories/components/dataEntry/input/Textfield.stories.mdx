...
import TextField, { TextFieldTypes, TextFieldAligns, TextFieldColor } from '@/components/components/dataEntry/input/TextField';
            ...
            template: `
                <div style="width:300px">
                    ...
                    <TextField
                        ...
                        :outline="false"
                        label="label"
                        placeholder="underline + hint + label"
                        active
                        class="mb-20"
                    />
                    <TextField
                    ...
                    <TextField
                        ...
                        outline
                        label="label"
                        placeholder="outline + hint + label"
                        active
                        class="mb-20"
                    />
                </div>
