          ...
          methods: {
            ...
            template: `<div style="width: 100%; display: flex; justify-content: center; align-items: center; flex-direction: column;">
                        ...
                        <div style="width: 100%; margin-bottom: 30px;">
                            ...
                            />
                            <FileList :files="errorFiles" isRemovable @clickFileTrashIcon="handleErrorClickTrashIcon" @clickFileItemContent="handleClickFileItemContent"/>
                        </div>
                         <div style="width: 100%; margin-bottom: 30px;">
             ...
             components: { FileInput, FileList, FileSummary, Typography },
        }}
    </Story>
</Canvas>
