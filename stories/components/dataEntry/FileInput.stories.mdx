...
import CFileInput from '@/components/components/dataEntry/input/CFileInput';
import CFileList from '@/components/components/dataDisplay/list/fileList/CFileList';
import CFileSummary from '@/components/components/dataDisplay/list/fileList/CFileSummary';
...
export const Default = (args, { argTypes }) => ({
  ...
  template: `<div style="width: 100%; display: flex; justify-content: center; align-items: center; flex-direction: column;">
                <div style="width: 100%">
                 <CFileInput :accept="accept" :multiple="multiple" :full="full" @uploadFiles="handleUploadFiles" />
                 <CDivider type="dash" style="margin-top: 8.5px; margin-bottom: 12.5px;"/>
                 <CFileList :files="files" @clickFileDownloadIcon="handleClickFileDownloadIcon" @clickFileItemContent="handleClickFileItemContent"/>
                 </div>
              </div>`,
          ...
          methods: {
            ...
            template: `<div style="width: 100%; display: flex; justify-content: center; align-items: center; flex-direction: column;">
                        <div style="width: 100%; margin-bottom: 30px;">
                            ...
                            />
                            <CDivider type="dash" style="margin-top: 8.5px; margin-bottom: 12.5px;"/>
                            <CFileList :files="createFiles" isEdit @clickFileTrashIcon="handleCreateClickTrashIcon" @clickFileItemContent="handleClickFileItemContent"/>
                        </div>
                        <div style="width: 100%; margin-bottom: 30px;">
                            ...
                            />
                            <CDivider type="dash" style="margin-top: 8.5px; margin-bottom: 12.5px;"/>
                            <CFileList :files="editFiles" isEdit @clickFileTrashIcon="handleEditClickTrashIcon" @clickFileItemContent="handleClickFileItemContent"/>
                        </div>
                         <div style="width: 100%; margin-bottom: 30px;">
