            ...
            template: `
                <div>
                  <div style="display: flex">
                    ...
                    <Button color="accent" type="fill" size="medium" loading>Fill Accent</Button>
                  ...
                  <div style="display: flex">
                    ...
                    <Button color="accent" type="outline" size="medium" loading>Fill Accent</Button>
            ...
            template: `
                <div>
                  <div style="display: flex">
                    ...
                    <Button color="accent" type="fill" size="medium" disabled>
                        <template v-slot:left-icon>
                            <Icon name="IconPlusSmallLine" color="accent" />
                        </template>
                        Fill Accent
                    </Button>
                  ...
                  <div style="display: flex">
                    ...
                    <Button color="accent" type="outline" size="medium" disabled>
                        <template v-slot:left-icon>
                            <Icon name="IconPlusSmallLine" color="accent" />
                        </template>
                        Fill Accent
                  ...
                  <div style="display: flex">
                    ...
                    <Button color="accent" type="text" size="medium" disabled>
                        <template v-slot:left-icon>
                            <Icon name="IconPlusSmallLine" color="accent" />
                        </template>
                        Fill Accent
