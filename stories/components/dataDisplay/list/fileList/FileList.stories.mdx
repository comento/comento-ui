...
<Meta
  ...
  argTypes={{
    files: {
      ...
      defaultValue: [
        {
          file: { name: "1.png"}, isLoading: false, isError: false,
        },
        {
          file: { name: "2.png"}, isLoading: false, isError: false,
        },
        {
          file: { name: "3.png"}, isLoading: false, isError: false,
        },
      ],
      control: {
        type: "array",
...
export const Default = (args, { argTypes }) => ({
  ...
  template: `<div style="width: 100%; display: flex; align-items: flex-start; flex-direction: column;">
   ...
   components: { FileList, FileSummary, FileInput, FileItem },
});
