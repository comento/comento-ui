...
<Canvas>
    <Story name="InputGroup" height="100px">
        {{
                    ...
                    >
                        ...
                        <template v-slot:content>
                            <InputGroup class="mb-12">
                                ...
                                <Button type="outlined" @click="handleSubmitModal">등록하기</Button>
                            </InputGroup>
                            <InputGroup>
                                <span class="mr-4">
                                    <Input
            ...
            `,
            components: {
                WithFormModal, Input, Button, InputGroup
            }
        }}
    </Story>
</Canvas>
                ...
                <div>
                    ...
                    >
                        ...
                        <template v-slot:content>
                            ...
                            <Select v-model="value" :options="['Option1', 'Option2', 'Option3', 'Option4', 'Option5']"></Select>
                        </template>
                    </WithFormModal>
                </div>
            `,
