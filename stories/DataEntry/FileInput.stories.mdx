          ...
          methods: {
            ...
            template: `<div style="width: 100%; display: flex; justify-content: center; align-items: center; flex-direction: column;">
                        <div style="width: 100%; margin-bottom: 30px;">
                            ...
                            />
                            <Divider type="dash" vertical style="margin-top: 8.5px; margin-bottom: 12.5px;"/>
                            <FileList :files="createFiles" isEdit @clickTrashIcon="handleCreateClickTrashIcon" @clickItemContent="handleClickItemContent"/>
                        </div>
                        <div style="width: 100%; margin-bottom: 30px;">
                            ...
                            />
                            <Divider type="dash" vertical style="margin-top: 8.5px; margin-bottom: 12.5px;"/>
                            <FileList :files="editFiles" isEdit @clickTrashIcon="handleEditClickTrashIcon" @clickItemContent="handleClickItemContent"/>
                        </div>
                         <div style="width: 100%; margin-bottom: 30px;">
